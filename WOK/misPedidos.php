	 		...
	 		<nav  class="red accent-2">
		 		<div class="nav-wrapper">
			      <div class="col s12">
			        ...
			        <a href="misPedidos.php" class="breadcrumb">Historial</a>
		   	...
		   	<div class="col s12">
		   		<table class="highlight">
		   			...
		   			<?php
						...
						if ($consulta=$conexionBD->query("SELECT * FROM pedidos WHERE login like '%".$_SESSION['usuario']->getNick()."%'")) {
							...
							while ($filas=$consulta->fetch_array()) {
								...
								echo "<tr>
										...
										;
								if ($filas[6]==0) {
										echo "<td style='color:red'>No entregado</td></tr>";
								}else{
										echo "<td style='color:green'>Entregado</td></tr>";
								}		
